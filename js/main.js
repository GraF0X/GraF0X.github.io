...
function enterKey(e) {
  ...
  if (e.keyCode === 13) {
    ...
    addLine("[vvs@fzerox]~$ " + command.innerHTML, "no-animation", 0);
...
function commander(cmd) {
  switch (cmd.toLowerCase()) {
    ...
    case "email":
      addLine(
        'Opening mailto:<a href="mailto:more.zgraf@gmail.com"> more.zgraf@gmail.com</a>...',
        "color2",
        80,
      );
      newTab(email);
...
case "friend":
      loopLines(friend, "color2 margin", 80);
      break;
